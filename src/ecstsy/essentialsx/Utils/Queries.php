...
class Queries {
        ...
        // WARPS QUERY 
        public const WARPS_INIT   = "players.warps.initialize";
        public const WARPS_SELECT = "players.warps.select";
        public const WARPS_CREATE = "players.warps.create";
        public const WARPS_UPDATE = "players.warps.update";
        public const WARPS_DELETE = "players.warps.delete";
}
